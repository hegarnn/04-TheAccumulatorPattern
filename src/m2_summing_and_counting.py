...
def run_test_sum_more_cosines():
    ...
    if answer is not None:
        ...
        # Test 2:
    expected = -.868837  # This is APPROXIMATELY the correct answer.
    ...
    if answer is not None:
        ...
        # Test 3:
    expected = .5901888  # This is APPROXIMATELY the correct answer.
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 3:
    expected = 76
    answer = count_sines_vs_cosines(76)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 26
    answer = count_sines_vs_cosines(26)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)
